...
public class TransaccionService {
         ...
         */
        @Transactional(readOnly = true)
        public List<TransaccionResponseDTO> listarPorProyeccion(Long proyeccionId, Long usuarioId) {
                return transaccionRepository.findByProyeccionId(proyeccionId).stream()
