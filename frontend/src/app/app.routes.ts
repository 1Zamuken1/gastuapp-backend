  ...
  // Todas las rutas dentro del Layout requieren autenticación
  {
    ...
    children: [
      ...
      // Proyecciones
      {
        path: 'proyecciones',
        loadComponent: () =>
          import('./features/proyecciones/proyecciones.component').then(
            (m) => m.ProyeccionesComponent,
          ),
        title: 'Proyecciones - GastuApp',
      },
      // Planificaciones (Presupuestos)
      {
        path: 'planificaciones',
        loadComponent: () =>
          import('./features/planificaciones/planificaciones.component').then(
            (m) => m.PlanificacionesComponent,
          ),
        title: 'Planificaciones - GastuApp',
      },
    ],
  },
